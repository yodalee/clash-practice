...
- [Project overview](#project-overview)
  - [clash-learning.cabal](#namecabal)
...
Note: If you need a newer Clash version, simply change the version bounds in `clash-learning.cabal` and follow the hints given by Stack.

## src/
This is where the source code of the project lives, as specified in `clash-learning.cabal`. It contains a single file, `Example/Project.hs` which starts with:
...
# Change the license
By default `clash-learning.cabal` sets its `license` field to `BSD-2-Clause`. You might want to change this.
